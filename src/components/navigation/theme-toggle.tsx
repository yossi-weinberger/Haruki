...
export default function ThemeToggle() {
  ...
  useEffect(() => {
    ...
    const handleThemeChange = () => {
      setIsSystemDark(mediaQueryList.matches);
    };
  ...
  const isDark = selectedTheme === 'dark' || (selectedTheme === 'system' && isSystemDark);
      ...
      <div className='theme-switch__container'>
        ...
        <div className='theme-switch__circle'>
          ...
          <div className='theme-switch__moon'>
            <span className='theme-switch__moon-spot' />
            <span className='theme-switch__moon-spot theme-switch__moon-spot--2' />
            <span className='theme-switch__moon-spot theme-switch__moon-spot--3' />
          </div>
        </div>
      </div>
    </label>
